...
class OctarSolver(Solver):
    ...
    def generate_iter(self, iter):
        ...
        octree_out, vq_indices = self.model.generate(
            octree_out, depth_low=self.full_depth, depth_high=self.depth_stop, vqvae=self.vqvae)
        ...
        zq = self.vqvae.quantizer.embedding(vq_indices)
